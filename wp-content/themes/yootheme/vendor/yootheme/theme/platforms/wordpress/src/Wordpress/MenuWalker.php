...
class MenuWalker extends \Walker_Nav_Menu
{
     ...
     * Constructor.
     */
    public function __construct($theme, $position)
    {
        $this->theme = $theme;
    ...
    public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
    {
        ...
        // set menu config
        $item->config = new Collection($this->theme['@config']->get("menu.items.{$item->ID}", []));
    ...
    public function walk($elements, $max_depth)
    {
        ...
        echo $this->theme->render('menu/menu', ['items' => $this->items, 'params' => new Collection(), 'position' => $this->position]);
    }
}
