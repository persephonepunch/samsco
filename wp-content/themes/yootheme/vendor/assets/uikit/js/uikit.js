    ...
    if (Observer) {
        ...
        ready(function () {
            ...
            on(document.body, 'DOMNodeRemoved', function (e) {
                return apply(e.target, UIkit.detachComponents);
            });
        });
    }
...
function componentAPI (UIkit) {
    ...
    UIkit.attachComponents = function (element) {
        if (!element[DATA]) {
            return;
        }
    ...
    UIkit.detachComponents = function (element) {
        ...
        _toggleElement: function _toggleElement(el, show, animate) {
            ...
            if (Animation.inProgress(el)) {
                ...
                return deferred.then(function () {
                    return _this2._toggleElement(el, show, animate);
                });
            }
