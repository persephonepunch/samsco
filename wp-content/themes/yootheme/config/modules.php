...
return [
    ...
    'fields' => [
        ...
        'text_align_breakpoint' => [
            ...
            'show' => '(position == "top" || position == "bottom" || position == "sidebar" || position == "mobile") && text_align && text_align != "justify"',
        ],
        ...
        'text_align_fallback' => [
            ...
            'show' => '(position == "top" || position == "bottom" || position == "sidebar" || position == "mobile") && text_align && text_align != "justify" && text_align_breakpoint',
        ],
        ...
        'list_style' => [
            ...
            'show' => '["articles_archive","articles_categories","articles_latest","articles_popular","tags_popular","tags_similar"].indexOf(type) != -1 || ["recent-posts","pages","recent-comments","archives","categories","meta"].indexOf(type) != -1',
        ],
